...
namespace TestsXb.Db
{
    ...
    public class MsSqlModelTests : MsSqlBase, IDisposable
    {
        ...
        {
            var col = this._test2Model.GetCol("COL_STR");
            ...
            col = this._testModel.GetCol("COL_DEC");
        ...
        {
            var col = this._test2Model.GetCol(0);
            Assert.AreEqual("COL_STR", col.Name);
            Assert.AreEqual(Xb.Db.Model.ColumnType.String, col.Type);
            Assert.AreEqual(10, col.MaxLength);
            Assert.IsFalse(col.IsNullable);
        ...
        public void ValidateTest()
        {
            ...
            Assert.AreEqual(4, this._testModel.Columns.Count);
        ...
        public void WriteTest()
        {
            ...
            var sql = "SELECT * FROM Test2 ORDER BY COL_STR ";
        ...
        public void InsertTest()
        {
            ...
            var sql = "SELECT * FROM Test ORDER BY COL_STR ";
            var table = this._db.Query(sql);
        ...
        public void ReplaceUpdateTest()
        {
            ...
            var errs = this._test2Model.ReplaceUpdate(rows.ToArray());
            Assert.AreEqual(0, errs.Length);
            ...
            errs = this._test2Model.ReplaceUpdate(newRows.ToArray(), rows.ToArray(), "COL_DATETIME");
            Assert.AreEqual(0, errs.Length);
            ...
            errs = this._test2Model.ReplaceUpdate(newRows.ToArray());
            Assert.AreEqual(0, errs.Length);
        ...
        public void DisposeTest()
        {
            ...
            var select = "SELECT * FROM Test3 ORDER BY COL_STR";
            var oldTable = this._db.Query(select);
            ...
            newTable.Columns.Add("COL_STR");
            newTable.Columns.Add("COL_DEC");
            newTable.Columns.Add("COL_INT");
            newTable.Columns.Add("COL_DATETIME");
